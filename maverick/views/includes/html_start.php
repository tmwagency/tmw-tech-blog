...
<html lang="en">
	<head>
		...
		<title>{{ page.title }} - tech.tmw.co.uk</title>
		...
		<script>var pageName = '{{ page.pageid }}';</script>
		...
		<meta name="twitter:url" content="http://tech.tmw.co.uk{{ page.url }}" />


		<!-- Open Graph data -->
		<meta property="og:title" content="{{ page.title }}" />
		<meta property="og:type" content="article" />
		<meta property="og:url" content="http://tech.tmw.co.uk{{ page.url }}" />
		<meta property="og:image" content="http://tech.tmw.co.uk/img/favicons/apple-touch-icon-152x152.png" />
